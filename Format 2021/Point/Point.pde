...
void oscEvent(OscMessage msg) {
  ...
  if (msg.checkAddrPattern("point_hpq")) {
    float x = msg.get(0).floatValue();
    float meshDistortion = random(0.0, 0.5);
    float form = (int)random(1.0, 20.0);
    float meshAlpha = random(1.0,100.0);
    if (x == 0.001) {
      controlP5.getController("meshDistortion").setValue(meshDistortion);
      controlP5.getController("form").setValue(form);
    } else {
  ...
  /////////////////////////////////////POINT PAN ///////////////////////////
  if (msg.checkAddrPattern("point_pan")) {
    float x = msg.get(0).floatValue();
    if (x == 0) {
      println(0);
  ...
  if (msg.checkAddrPattern("setup")) {
    ...
    //triangles
    //strip
    controlP5.getController("form").setValue(5);
    controlP5.getController("meshScale").setValue(300);
    controlP5.getController("meshCount").setValue(204);
    ...
    ranges[0].setLowValue(183.0);
    ranges[1].setHighValue(100.0); //sat
    ranges[1].setLowValue(90.0);
    ranges[2].setHighValue(100.0); // bright
    ranges[2].setLowValue(90.0);
    ranges[3].setHighValue(0.22); //uRange
    ranges[3].setLowValue(0.38);
    ranges[4].setHighValue(3.14); //vRange
    ranges[4].setLowValue(-2.51);
    controlP5.getController("randomUCenterRange").setValue(1.13);
    controlP5.getController("randomVCenterRange").setValue(3.26);
    controlP5.getController("paramExtra").setValue(1);
    controlP5.getController("uCount").setValue(2);
    controlP5.getController("vCount").setValue(5);
    controlP5.getController("randomScaleRange").setValue(4.0);
    controlP5.getController("meshDistortion").setValue(0.00);
  };
 ...
 if (msg.checkAddrPattern("paramExtra")) {
    float x = msg.get(0).floatValue();
    float xMap = map(x, 0.0, 1.0, -10.0, 10.0);


    controlP5.getController("paramExtra").setValue(xMap);
