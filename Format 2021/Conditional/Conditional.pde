...
void oscEvent(OscMessage msg) {
  ...
  if (msg.checkAddrPattern("conditional_dec")) {
  ...
  if (msg.checkAddrPattern("loopA_pan")) {
    float x = msg.get(0).floatValue();

    float meshAlpha = map(x, -1, 1, 10.0, 100.0);
  ...
  if (msg.checkAddrPattern("loopA_distortion")) {
    float x = msg.get(0).floatValue();

    controlP5.getController("meshDistortion").setValue(x);
  ...
  if (msg.checkAddrPattern("loopB_distortion")) {
    float x = msg.get(0).floatValue();
    ...
    if (msg.checkAddrPattern("loopA_kick")) {
  ...
  if (msg.checkAddrPattern("loopB_dec")) {
    float x = msg.get(0).floatValue();

    float meshAlpha = map(x, 0.0, 0.25, 10.0, 100.0);
  ...
  if (msg.checkAddrPattern("loopB_kick")) {
    float x = msg.get(0).floatValue();



    if (x ==4) {
      controlP5.getController("meshAlpha").setValue(0.0);
    };
  ...
  if (msg.checkAddrPattern("setup")) {
    ...
    controlP5.getController("form").setValue(13);
    controlP5.getController("meshScale").setValue(189);
    controlP5.getController("meshCount").setValue(450);
    controlP5.getController("meshAlpha").setValue(44.66);
    controlP5.getController("meshSpecular").setValue(255);
    ranges[0].setHighValue(15.42); // hue
    ranges[0].setLowValue(0.0);
    ranges[1].setHighValue(6.0); //sat
    ranges[1].setLowValue(00.0);
    ranges[2].setHighValue(100.0); // bright
    ranges[2].setLowValue(90.0);
    ranges[3].setHighValue(0.89); //uRange
    ranges[3].setLowValue(0.78);
    ranges[4].setHighValue(2.60); //vRange
    ranges[4].setLowValue(1.78);
    ...
    controlP5.getController("randomScaleRange").setValue(1.56);
    controlP5.getController("meshDistortion").setValue(0.36);
  };
  ...
  if (msg.checkAddrPattern("uRangeHigh")) {
    float x = msg.get(0).floatValue();
    float xMap = map(x, 0.0, 1.0, 1.16, 1.34);
  ...
  if (msg.checkAddrPattern("vRangeLow")) {
    float x = msg.get(0).floatValue();
    float xMap = map(x, 0.0, 1.0, 1.70, 1.50);
