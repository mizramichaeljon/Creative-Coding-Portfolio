...
float rotationX = -0.5, rotationY = 0, rotationZ = 0, targetRotationX = 0, targetRotationY = 0, clickRotationX, clickRotationY; 
...
void oscEvent(OscMessage msg) {
  ...
  if (msg.checkAddrPattern("setup")) {
    ...
    controlP5.getController("meshScale").setValue(252);
    controlP5.getController("meshCount").setValue(6);
    ...
    controlP5.getController("randomScaleRange").setValue(2.58);
    controlP5.getController("meshDistortion").setValue(0.03);
