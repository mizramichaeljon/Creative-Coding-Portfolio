...
void oscEvent(OscMessage msg) {
  ...
  if (msg.checkAddrPattern("untitled_freq")) {
  ...
  if (msg.checkAddrPattern("untitled_dur")) {
    float x = msg.get(0).floatValue(); 
    ...
    if (msg.checkAddrPattern("untitled_pan")) {
    float x = msg.get(0).floatValue(); 
    float uCount = map(x,-1,1,0,12);
    
    controlP5.getController("uCount").setValue(uCount);
  ...
  if (msg.checkAddrPattern("setup")) {
    ...
    controlP5.getController("form").setValue(20);
    controlP5.getController("meshScale").setValue(300.00);
    controlP5.getController("meshCount").setValue(450);
    controlP5.getController("meshAlpha").setValue(78.00);
    controlP5.getController("meshSpecular").setValue(255.00);
    controlP5.getController("uCount").setValue(1);
    controlP5.getController("vCount").setValue(3);
    controlP5.getController("randomScaleRange").setValue(1.71);
    controlP5.getController("meshDistortion").setValue(0.19);
    ...
    controlP5.getController("paramExtra").setValue(-4.86);
  };
  ...
  if (msg.checkAddrPattern("uRangeLow")) {
    float x = msg.get(0).floatValue();
    float xMap = map(x, 0.0, 1.0, -3.14, 0.8);
  ...
  if (msg.checkAddrPattern("uRangeHigh")) {
    float x = msg.get(0).floatValue();
    float xMap = map(x, 0.0, 1.0, 0.76, 3.14);
  ...
  if (msg.checkAddrPattern("randomScaleRange")) {
    float x = msg.get(0).floatValue();
    float xMap = map(x, 0.0, 1.0, 0.00, 4.00);
  ...
  if (msg.checkAddrPattern("meshSpecular")) {
    float x = msg.get(0).floatValue();
    float xMap = map(x, 0.0, 1.0, 0.0, 255.0);
